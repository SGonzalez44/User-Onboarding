    ...
    return (
        <div>
            <Form>
                ...
                <label name = "terms-of-service"><a href='/agreed'>Terms of service:</a></label>
...
const formikSal = withFormik({//this renames and assigns value to the withFormic function
...
const UserFormWithFormik = formikSal(UserForm); //this uses the above formik form plus adding in the original UserForm to a user form with formik that we then export.
